...
version = sigutils.__version__
# The full version, including alpha/beta/rc tags.
release = sigutils.__version__
...
latex_documents = [
  ('index', 'sigutils.tex', u'sigutils Documentation',
   u'Ryan Dwyer', 'manual'),
]
...
man_pages = [
    ('index', 'sigutils', u'sigutils Documentation',
     [u'Ryan Dwyer'], 1)
]
...
texinfo_documents = [
  ('index', 'sigutils', u'sigutils Documentation',
   u'Ryan Dwyer', 'sigutils', 'One line description of project.',
   'Miscellaneous'),
]
